...
public class PowerUp extends GameObject {
    private final String ID1_IMAGE = "C:\\Users\\Alper\\IdeaProjects\\draftproject\\src\\sample\\powerUp_regen.png";
    private final String ID2_IMAGE = "C:\\Users\\Alper\\IdeaProjects\\draftproject\\src\\sample\\pwup_fuel_energy.png";
    ...
    public PowerUp(Image image, double xPos, double yPos, double xVelocity, double yVelocity, int quantityOfEffect, int ID, int score) {
        super(image, xPos, yPos, xVelocity, yVelocity, true, "Power Up");
